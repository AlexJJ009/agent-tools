...
Use this skill before claiming a task is complete, before a formal experiment, before production or external publishing, and when high-risk checklist items need Agent -> human double confirmation.

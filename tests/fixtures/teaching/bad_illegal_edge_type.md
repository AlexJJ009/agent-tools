---
title: Bad illegal edge type fixture
---
...
```json teaching-manifest
{
  ...
  "artifact_id": "fixture-bad-illegal-edge-type",
  "mode": "guided",
  ...
  "knowledge_components": [
    {"id": "kc.a", "ability": "A", "state": "callable", "definition": "A", "why_needed": "A", "prerequisites": [], "witnesses": ["anchor.paper"], "worked_example": "A", "checks": ["check.a.reconstruct", "check.a.retrieve"]},
  ...
  "teaching_edges": [
    {"id": "edge.a-b", "from": "kc.a", "to": "kc.b", "edge_type": "magical", "failure_without": "B fails.", "witness": "anchor.paper"}
  ],
  "frontier": ["kc.b"],
  "evidence_anchors": [
  ...
  "learning_checks": [
    ...
    {"check_id": "check.b.reconstruct", "kc": "kc.b", "type": "reconstruction", "prompt": "B", "success_signal": "B", "failure_prerequisite": "kc.a", "evidence": ["anchor.paper"]},
    {"check_id": "check.b.retrieve", "kc": "kc.b", "type": "retrieval", "prompt": "B", "success_signal": "B", "failure_prerequisite": "kc.a", "evidence": ["anchor.paper"]}
  ],
  "review_queue": []
}
```

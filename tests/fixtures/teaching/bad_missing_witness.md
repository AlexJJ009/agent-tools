---
title: Bad missing witness fixture
---
...
```json teaching-manifest
{
  ...
  "artifact_id": "fixture-bad-missing-witness",
  "mode": "guided",
  ...
  "teaching_edges": [
    {"id": "edge.a-b", "from": "kc.a", "to": "kc.b", "edge_type": "strict", "failure_without": "B fails.", "witness": "anchor.missing"}
  ],
  "frontier": ["kc.b"],
  "evidence_anchors": [

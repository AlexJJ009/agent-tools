---
title: Bad review queue orphan fixture
---
...
```json teaching-manifest
{
  ...
  "artifact_id": "fixture-bad-review-queue-orphan",
  "mode": "guided",
  ...
  "review_queue": [
    {"card_id": "card.orphan", "kc": "kc.review", "prompt": "Review", "due_or_trigger": "later", "target_note": "[[notes/teaching/review]]", "check_id": "check.missing", "status": "open"}
  ]
}
```
